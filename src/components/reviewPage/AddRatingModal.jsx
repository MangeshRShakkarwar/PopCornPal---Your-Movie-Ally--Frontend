  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <textarea
        ...
        className="h-24 w-full mb-2 p-2 border-2 border-dark-subtle outline-none resize-none text-white rounded-md indent-1 bg-transparent hover:border-primary-red transition duration-300"
        placeholder="What do you think about this movie?"
      ></textarea>
      <SubmitBtn onclick={handleSubmit} value="Submit" busy={isPending} />
    </div>
  );
}
